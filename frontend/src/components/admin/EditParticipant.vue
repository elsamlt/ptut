      ...
      <v-card class="pa-5">
        ...
        <div class="d-flex flex-column align-center">
          ...
          <v-col cols="12" md="10">
            <v-row>
              <v-col cols="6">
                <v-text-field label="Nom" v-model="person.nom" required></v-text-field>
              </v-col>
              <v-col cols="6">
                <v-text-field label="Prénom" v-model="person.prenom" required></v-text-field>
              </v-col>
              <v-col cols="6">
...
const submitPerson = () => {
  if (person.value.photo == props.person.photo) {
    person.value.photo = props.person.photo; // photo initiale
  }
  emit("edit", person.value);
};
